...
//  Empty and repopulate drop down menus for titer
    ...
    var sickle1 = function() {
        if(sickle == true){
            document.antigenForm.textField.value += " hemoglobin S-negative";
        }
    };
  ...
  //  define function for non-specific antibodies  *** need to add case with both WAA and nonspecific reactivity ****
   var nonspecific = function () {
      if(document.antigenForm.nonspecificReactivity.checked  &&  numberAntibodies === 0) {
        document.antigenForm.textField.value = "";
        presurgery();
        document.antigenForm.textField.value += "This test suggested a red cell antibody in the patient's plasma. However, all common clinically significant alloantibodies were ruled out with reagent red blood cells.  Should this patient require transfusions in the future, extended crossmatch compatible units will be provided.  ";
    };
        if(document.antigenForm.nonspecificReactivity.checked  &&  numberAntibodies > 0) {
  ...
  // Provides sentence if patient has additional antibodies in a special case
    var patientAlsoHasAntibodies = function(m) {
        if(patientClinicalAntibodies.length > 1) {
            ...
            document.antigenForm.textField.value += "This patient also has anti-" + conjoin(alsoHasAntibodies);
        };
    };
 ...
 //          document.antigenForm.textField.value +="If red cell transfusion is necessary, the Blood Bank will issue extended crossmatch compatible Rh negative units. ";    
    ...
    var MAndOther = function () {
        if (numberAntibodies > 1 && antigen[15].checked) {
            document.antigenForm.textField.value += "This patient also has anti-M which can be naturally occurring and does not react at body temperature; thus, it is not clinically significant. ";
        };
    };
   // Anti-N and one or more alloantibody
    var NAndOther = function () {
        if (numberAntibodies > 1 && antigen[16].checked) {
            document.antigenForm.textField.value += "The patient also has anti-N which is a cold reacting antibody and typically not clinically significant. ";
        };
    };
    // Anti-P1 and one or more alloantibody
    var P1ndOther = function () {
        if (numberAntibodies > 1 && antigen[20].checked) {
            document.antigenForm.textField.value += "This patient also has anti-P1 which can be naturally occurring and does not cause transfusion reactions. ";
        };
    };
    // Define patient sex    
    for(i = 0; i < 2; i++) {
    ...
    var lewisGroup = function () {
        ...
        if (numberClinicalAntibodies >= 1) {
            if (antigen[21].checked && antigen[22].checked == '0') {
                document.antigenForm.textField.value += "The patient also has an anti-Lewis A. Anti-Lewis A can be naturally occurring and does not cause hemolytic transfusion reactions. Thus, it is not clinically significant. ";
            };
        };
        if (numberClinicalAntibodies === 0) {
            if (antigen[21].checked && antigen[22].checked == '0') {
                document.antigenForm.textField.value += "The patient has an anti-Lewis A. Anti-Lewis A can be naturally occurring and does not cause hemolytic transfusion reactions. Thus, it is not clinically significant. ";
            };
        };
        //Lewis b antibodies
        if (numberClinicalAntibodies >= 1) {
            if (antigen[22].checked && antigen[21].checked == '0') {
                document.antigenForm.textField.value += "The patient also has an anti-Lewis B. Anti-Lewis B can be naturally occurring and does not cause hemolytic transfusion reactions. Thus, it is not clinically significant. ";
            };
        };
        if (numberClinicalAntibodies === 0) {
            if (antigen[22].checked && antigen[21].checked == '0') {
                document.antigenForm.textField.value += "The patient has an anti-Lewis B. Anti-Lewis B can be naturally occurring and does not cause hemolytic transfusion reactions. Thus, it is not clinically significant. ";
            };
        };
        if (numberClinicalAntibodies >= 1) {
            if (antigen[21].checked && antigen[22].checked) {
                document.antigenForm.textField.value += "The patient also has an anti-Lewis A and an anti-Lewis B. Anti-Lewis A and B can be naturally occurring and do not cause hemolytic transfusion reactions. Thus, they are not clinically significant. ";
            }
            ;
        };
        if (numberClinicalAntibodies == 0) {
            if (antigen[21].checked && antigen[22].checked) {
                document.antigenForm.textField.value += "The patient has an anti-Lewis A and an anti-Lewis B. Anti-Lewis A and B can be naturally occurring and do not cause hemolytic transfusion reactions. Thus, they are not clinically significant. ";
            };
    ...
    var patientMustReceive = function () {
        if (patientSexA != 0 && numberClinicalAntibodies >= 1) {
            if (document.antigenForm.antigen[0].checked == false) {
                document.antigenForm.textField.value += "If transfusion is necessary, " +  heOrShe(patientSexA) + " must receive extended crossmatch compatible " + conjoinB(patientClinicalAntibodies) + "-antigen negative units. ";
            }
            else if (document.antigenForm.antigen[0].checked == true && numberClinicalAntibodies == 1){
                document.antigenForm.textField.value += "If transfusion is necessary, " +  heOrShe(patientSexA) + " must receive extended crossmatch compatible Rh negative units. ";
            }

            else{
                document.antigenForm.textField.value += "If transfusion is necessary, " +  heOrShe(patientSexA) + " must receive" + sickle1(sicklePatient) + " extended crossmatch compatible Rh negative units that are also lacking ";
                antigensOtherThan("D");
                document.antigenForm.textField.value += " antigens.   ";
            };
                   if (document.antigenForm.warmAuto.checked) {  
            document.antigenForm.textField.value += "The Blood Bank will issue units that are compatible with the patient's plasma after the autoantibody is removed by adsorption with the patient's cells. ";
            };
         };
    };
...
// Strong warm autoantibody with no alloantibodies
 ...
 // Anti-N, cold reacting with no additional alloantibodies
    if(numberAntibodies === 1 && antigen[16].checked) {
        document.antigenForm.textField.value = "";
        presurgery();
        document.antigenForm.textField.value += "This patient has anti-N. This antibody typically does not react at body temperature; thus, it is not clinically significant.  If transfusion is necessary, " + heOrShe(patientSexA) + " will receive appropriate pre-warm extended crossmatch compatible units. ";
        signature();     
    };
    ...
    if(numberAntibodies === 1 && antigen[20].checked) {
        document.antigenForm.textField.value = "";
        presurgery();
        document.antigenForm.textField.value += "This patient has anti-P1. This antibody is a fairly common naturally-occurring antibody that does not cause transfusion reactions. If transfusion is necessary, " + heOrShe(patientSexA) + " will receive appropriate extended crossmatch compatible units.  ";
        signature();
    };
    ...
    if(numberAntibodies === 1 && antigen[0].checked && GivenRhImmuno === true) {
        document.antigenForm.textField.value = "";
        presurgery();
        document.antigenForm.textField.value += "The patient has anti-D, likely due to Rh immunoglobulin administration during this pregnancy.  If transfusion is necessary, the Blood Bank will issue extended crossmatch compatible Rh negative units to prevent sensitization to the D antigen.  ";
     //   presurgery();
   //     document.antigenForm.textField.value += "This patient has anti-M. This antibody can be naturally occurring and does not react at body temperature; thus, it is not clinically significant.  If transfusion is necessary, " + heOrShe(patientSexA) + " will receive appropriate pre-warm extended crossmatch compatible units. ";
        signature();
    };
...
// Special case  f antibody
 if (document.antigenForm.specialOptions.value == "f" && patientSpecialCase===true){
    ...
    lewisGroup();
    lutheranGroup();
    document.antigenForm.textField.value += "If transfusion is necessary, the patient will be provided with extended crossmatch compatible units lacking the c-antigen. "; 
...
// Special case  IH antibody
    if (document.antigenForm.specialOptions.value == "antiIH" && patientSpecialCase===true){
        ...
        lewisGroup();
        lutheranGroup();
        document.antigenForm.textField.value += "If transfusion is necessary, the patient will be provided with pre-warmed extended crossmatch compatible units.  Such units will take considerable time to prepare.  ";
        if(numberClinicalAntibodies >= 1) {
            document.antigenForm.textField.value += "Approximately " + percentCompatible.toFixed(0) + "% of donor units are expected to be compatible. ";
        };
        signature();
    ...
    if (document.antigenForm.specialOptions.value == "QNS" && patientSpecialCase===true){
        presurgery();
        document.antigenForm.textField.value += "Additional sample is necessary to further characterize the reactivity demonstrating in the patient’s plasma.  At this point, the significance of this reactivity is unknown.  The work-up needs to be completed before fully crossmatched blood can be issued to the patient.  If the patient needs RBC prior to resolution of the positive antibody screen, emergency release units will be provided with the appropriate physician signature.  ";
        signature();
    };
